    ...
    <div class="aside-menu flex-column-fluid" id="kt_aside_menu">
        ...
        <div class="hover-scroll-overlay-y my-2 my-lg-5 pe-lg-n1" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside, #kt_aside_menu" data-kt-scroll-offset="5px">
            ...
            <div class="menu menu-column menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold" id="#kt_aside_menu" data-kt-menu="true">
                ...
                <div class="menu-item py-2">
                    <a class="menu-link menu-center {{ request()->is('pesawat') ? 'active' : '' }}" href="{{route('pesawat')}}" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                ...
                <div class="menu-item py-2">
                    <a class="menu-link menu-center {{ request()->is('destinasi') ? 'active' : '' }}" href="{{route('destinasi')}}" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                ...
                <div class="menu-item py-2">
                    <a class="menu-link menu-center {{ request()->is('hotel') ? 'active' : '' }}" href="{{route('hotel')}}" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                ...
                <div class="menu-item py-2">
                    <a class="menu-link menu-center {{ request()->is('tiket') ? 'active' : '' }}" href="{{route('tiket')}}" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                ...
                {{-- <div class="menu-item py-2">
                    <a class="menu-link menu-center {{ request()->is('users') ? 'active' : '' }}" href="{{route('home')}}" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                        <span class="menu-icon me-0">
